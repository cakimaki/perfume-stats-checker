...
public interface OfferRepository extends JpaRepository<Offer,Long> {
	...
	Optional<Offer> findByPerfumeVariantAndSiteAndOfferUrl(@Param("perfumeVariant") PerfumeVariant perfumeVariant, @Param("site") String site, @Param("offerUrl") String offerUrl);
